...
const ManagerLayout = () => {
  ...
  const handleSidebarToggle = () => {
    ...
    localStorage.setItem('managerSidebarCollapsed', JSON.stringify(newState))
  }

  const handleSidebarCollapse = (collapsed) => {
    setSidebarCollapsed(collapsed)
    localStorage.setItem('managerSidebarCollapsed', JSON.stringify(collapsed))
  }
        ...
        <footer className="bg-white border-t border-gray-200 px-4 py-3 flex-shrink-0">
          <div className="flex items-center justify-between text-sm text-gray-600">
            <div className="flex items-center space-x-4">
              <span>© {new Date().getFullYear()} SpaAdvisor</span>
              <span>•</span>
            ...
            <div className="flex items-center space-x-4">
              ...
              <a href="/manager/support" className="hover:text-gray-900">
                Support
              </a>
              <a href="/manager/privacy" className="hover:text-gray-900">
                Privacy
              </a>
            </div>
          </div>
