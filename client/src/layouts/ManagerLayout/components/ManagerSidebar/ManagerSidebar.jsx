          ...
          <div key={item.name}>
            <NavLink
              ...
              className={({ isActive }) => {
                ...
                const base = `flex items-center ${isCollapsed ? 'justify-center' : 'justify-start'} px-3 py-2.5  text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500/30 group`
