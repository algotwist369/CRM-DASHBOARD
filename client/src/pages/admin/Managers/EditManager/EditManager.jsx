...
const EditManager = () => {
    ...
    return (
        <div className="p-3 sm:p-6 bg-gray-50 min-h-screen">
            ...
            {/* Form */}
            <div className="bg-white border shadow-sm rounded-xl p-6 max-w-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex gap-3 pt-4">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="flex-1 bg-primary-600 hover:bg-primary-700 text-white py-3 rounded-lg font-medium transition disabled:opacity-50"
                            >
                                {loading ? (
