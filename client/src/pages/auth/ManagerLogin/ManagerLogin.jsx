...
const ManagerLogin = () => {
  ...
  useEffect(() => {
    const remembered = authService.getRememberedCredentials('manager')
    if (remembered) {
      setFormData(prev => ({
        ...prev,
      ...
      <div className='w-full max-w-md bg-white shadow-lg  p-8'>
        ...
        <form onSubmit={handleSubmit} className='space-y-5'>
          ...
          <button
            type='submit'
            disabled={isLoading}
            className='w-full bg-gray-800 text-white py-2  font-medium hover:bg-gray-700 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed'
          >
