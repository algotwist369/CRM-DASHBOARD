        ...
        <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #f9f9f9; padding: 40px 20px;">
            <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); overflow: hidden;">
                ...
                <div style="padding: 40px 30px; color: #444444; line-height: 1.6;">
                    <h2 style="color: #2c3e50; margin-top: 0; font-size: 20px;">Appointment Confirmed</h2>
                    <p style="margin-bottom: 25px;">Dear {{customerName}},</p>
                    
                    <p style="margin-bottom: 25px;">We are pleased to confirm your appointment with {{businessName}}. We are looking forward to seeing you.</p>
                    ...
                    <div style="background-color: #f8f9fa; border: 1px solid #e9ecef; border-radius: 6px; padding: 20px; margin-bottom: 30px;">
                        <table style="width: 100%; border-collapse: collapse;">
                            ...
                            <tr>
                                <td style="padding: 8px 0; color: #7f8c8d; font-size: 14px;">Reference</td>
                                <td style="padding: 8px 0; font-weight: 600; color: #2c3e50;">{{confirmationCode}}</td>
                            </tr>
                        </table>
                    </div>
                    
                    <p style="font-size: 14px; color: #7f8c8d;">Please arrive 10 minutes before your scheduled time. If you need to reschedule, please contact us at your earliest convenience.</p>
                    
                    <div style="text-align: center; margin-top: 30px;">
                        <a href="{{actionUrl}}" style="background-color: #3498db; color: #ffffff; text-decoration: none; padding: 12px 25px; border-radius: 4px; font-weight: bold; display: inline-block;">View Appointment</a>
                    </div>
                </div>
